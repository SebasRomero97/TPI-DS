            ...
            >
              <View className='justify-center'>
                ...
                <View className='flex-row justify-between pt-6'>
                  ...
                  <TouchableOpacity onPress={onAccept} className='rounded-md bg-[#2b27a8] items-center mr-8 px-8'><Text className='text-lg color-white p-3 font-semibold'>Ingresar</Text></TouchableOpacity>
                </View>
